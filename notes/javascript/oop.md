...
We try to look for a property/ method in the instance/object createad by new <Constructor Function>. If it is not found it will searched in the prototype of the object/instance.
...
const Person = function (firstName, birthyear) {
  ...
  // Never use methods in constructor functions as all objects created by the constructor function will have this method which can lead to performance issues.
  // For solving the above issue we should add the method in hte proptotype of the constructor function.
};
